...
def onEvent(evt):
    ...
    #print(evt['SPB_DET_AGIP1M-1/DET/STACKED:xtdf']['image.data'].data.shape)

    #print(evt['SPB_DET_AGIPD1M-1/DET/APPEND'].keys())

    #agipd_data = evt['SPB_DET_AGIPD1M-1/DET/APPEND']['image.data'].data
    #print(agipd_data.shape)
    #print(agipd_data.dtype) 
